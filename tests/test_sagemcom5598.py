...
class Sagemcom5598LiveTest(unittest.TestCase):
    ...
    def test_connected_extenders(self):
        ...
        for extender in extenders:
            for key in ("hostname", "model", "serial_number", "firmware", "ipv4", "uptime", "parent", "signal_strength_dbm"):
    ...
    def test_wan_ipv4(self):
        ...
        for key in ("status", "addressing_type", "address", "subnet", "gateway", "uptime", "mac_address"):
